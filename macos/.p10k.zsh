# Generated by Powerlevel10k configuration wizard on 2026-06-05 at 21:58 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#F2D188'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#F2D188'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#F6E7A1'
  ...
  typeset -g POWERLEVEL9K_VCS_FOREGROUND='#CBA6F7'
